...
import houseImg from '../../assets/gallery/g26.jpg';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-6 space-y-8">
            <div>
              ...
              <h2 className="font-sans text-4xl sm:text-5xl font-black uppercase tracking-tight text-[#2D332F] leading-[1.05]">
                Fully Stocked <br />
                <span className="text-[#ff6e00]">Chef's Kitchen</span>
              </h2>
              <p className="font-sans text-base sm:text-lg text-[#5A605C] leading-relaxed mt-4">
                A beautiful culinary environment featuring premium granite and marble counters, fully stocked with utensils and cooking appliances.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                { name: "Premium Countertops", desc: "Impeccable marble and solid granite finishes." },
                { name: "Large Refrigerator", desc: "Best to buy a large bag of ice for drinks!" },
                { name: "Dishwasher Note", desc: "That would be you! (Assisted by daily housekeeping)." },
                { name: "Four-Burner Gas Range", desc: "Full-size oven and gas cooking range." },
                { name: "Microwave & Coffee Maker", desc: "Fully stocked with blender, dishes & utensils." },
                { name: "Toaster & Lobster Pot", desc: "Toaster and special lobster pot available." }
              ].map((item, idx) => (
          ...
          <div className="lg:col-span-6 h-[40vh] sm:h-[50vh] lg:h-[60vh] relative p-4 sm:p-6 flex items-center justify-center">
            ...
            <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-xl group">
              <img src={houseImg} alt="Villa Kitchen" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-[8s] ease-out" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
              <div className="absolute bottom-6 left-6 backdrop-blur-md bg-white/10 border border-white/20 p-4 rounded-xl">
                <p className="text-[9px] font-bold uppercase tracking-widest text-white/70">Interior Design</p>
                <p className="font-mono text-white text-xs font-semibold">Marble & Granite</p>
              </div>
            </div>
          </div>
