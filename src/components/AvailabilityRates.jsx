...
export default function AvailabilityRates() {
  const policies = [
    {
      icon: <UserCheck className="w-5 h-5 text-[#ff6e00]" />,
      title: "Maximum Occupancy",
      desc: "Accommodates up to 8 guests comfortably across 4 en-suite bedrooms."
    },
    {
      icon: <Calendar className="w-5 h-5 text-[#ff6e00]" />,
      title: "Minimum Stay",
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10">
        ...
        <div className="mb-20 flex flex-col lg:flex-row lg:items-end justify-between gap-8">
          <div>
            ...
            <h2 className="font-sans text-5xl sm:text-6xl lg:text-[80px] font-black uppercase tracking-tighter leading-[0.85] mb-8">
              Plan Your <br />
              <span className="text-[#ff6e00]">Retreat</span>
            </h2>
          </div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-stretch">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div className="space-y-10">
              {policies.map((policy, idx) => (
                <div key={idx} className="flex gap-5 group border-b border-[#E3E0D8]/60 pb-8 last:border-b-0 last:pb-0">
                  <div className="p-3 bg-white border border-[#E3E0D8] group-hover:border-[#ff6e00] transition-colors duration-300 rounded-full shrink-0">
                    {policy.icon}
                  </div>
                  <div>
            ...
            <div className="mt-12 p-8 border border-[#E3E0D8] bg-white rounded-2xl hover:border-[#ff6e00] transition-all duration-500 shadow-sm group">
              <div className="flex items-center gap-2.5 mb-3 text-[#ff6e00]">
          ...
          <div className="lg:col-span-7 bg-white border border-[#E3E0D8] p-8 sm:p-12 flex flex-col justify-between shadow-sm hover:border-[#ff6e00] rounded-2xl transition-colors duration-700">
            <div>
