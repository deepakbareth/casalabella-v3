    ...
    <section className="py-20 lg:py-28 max-w-7xl mx-auto px-6 sm:px-12 relative">
      ...
      <div className="relative z-10 space-y-12">
        ...
        {visibleCount < images.length && (
          <div className="text-center pt-8">
            <button 
              onClick={loadMore}
              className="px-8 py-3.5 bg-[#2D332F] text-white font-sans text-xs uppercase tracking-widest font-extrabold rounded-full hover:bg-[#ff6e00] transition-colors duration-300 shadow-md hover:shadow-lg cursor-pointer"
            >
      ...
      {activeImageIndex !== null && (
        <div 
          ...
          className="fixed inset-0 z-50 bg-black/90 backdrop-blur-sm flex flex-col justify-between p-4 transition-all duration-300"
        >
          {/* Lightbox Header */}
          ...
          <div className="w-full text-center py-4 z-50">
            <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-white/10 text-white font-sans text-[10px] uppercase tracking-wider font-extrabold">
              Click arrows or use keyboard left/right keys to navigate
            </span>
          </div>
